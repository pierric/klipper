...
static inline double rotary_two_arm_calc(double dx, double dy,
                                         double upper_arm2, double lower_arm2) {
...
static double rotary_stepper_calc_position(struct stepper_kinematics *sk,
