...
static double extruder_integrate(double base, double start_v, double half_accel,
...
static double extruder_integrate_time(double base, double start_v,
                                      double half_accel, double start,
                                      double end) {
...
static double pa_move_integrate(struct move *m, double pressure_advance,
...
static double pa_range_integrate(struct move *m, double move_time,
  ...
  while (unlikely(start < 0.)) {
    ...
    res += pa_move_integrate(prev, pressure_advance, base, start, prev->move_t,
                             start);
  }
...
void __visible extruder_set_pressure_advance(struct stepper_kinematics *sk,
...
struct stepper_kinematics *__visible extruder_stepper_alloc(void) {
