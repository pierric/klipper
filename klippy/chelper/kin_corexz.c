...
static double corexz_stepper_plus_calc_position(struct stepper_kinematics *sk,
                                                struct move *m,
                                                double move_time) {
...
static double corexz_stepper_minus_calc_position(struct stepper_kinematics *sk,
                                                 struct move *m,
                                                 double move_time) {
  struct coord c = move_get_coord(m, move_time);
  return c.x - c.z;
...
struct stepper_kinematics *__visible corexz_stepper_alloc(char type) {
