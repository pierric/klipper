...
static double trunnion_bc_stepper_calc_position(struct stepper_kinematics *sk,
                                                struct move *m,
                                                double move_time) {
  struct trunnion_bc_stepper *ds =
      container_of(sk, struct trunnion_bc_stepper, sk);
...
struct stepper_kinematics *__visible trunnion_bc_stepper_alloc(
    char axis, double offset_x, double offset_y, double offset_z,
